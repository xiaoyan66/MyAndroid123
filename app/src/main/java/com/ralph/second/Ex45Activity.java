    ...
    protected void initmycreate(Bundle savedInstanceState) {
        ...
        lm.requestLocationUpdates(LocationManager.GPS_PROVIDER, 3000, 10, new LocationListener() {
            ...
            public void onProviderEnabled(String provider) {
                if (ActivityCompat.checkSelfPermission(Ex45Activity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(Ex45Activity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
