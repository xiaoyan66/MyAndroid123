...
public class ZuoYe extends BaseActivity {
    ...
    String[] zuoye = {"hello world！", "放一个图片", "获取手机分辨率 ", "点击图片轮循", "画心", "完成布局", "霓虹灯闪烁",
            ...
            "搜索框，显示对应匹配的信息", "intent跳转 ","Tabhost 三个选项卡","Dialog弹出框的练习","手机语言设置不同，显示不同的界面","打电话的练习","ExpandListView和intent传参练习",
            "横,竖屏的时候显示不同的布局","用异步任务的方法下载资源时显示进度条","平板电脑和手机适配", "两个按钮一个回主页面，去百度另一个"};
    Class[] clazz = {Ex01Activity.class, Ex02Activity.class, Ex03Activity.class, Ex04Activity.class,
            ...
            Ex27Activity.class, Ex28Activity.class, Ex29Activity.class, Ex30Activity.class, Ex31Activity.class};
